...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white">
      <header className="border-b border-gray-800/50 px-4 sm:px-6 md:px-12 py-6 flex-shrink-0">
        <div className="max-w-[1800px] mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <BookOpen className="w-9 h-9 text-purple-400" />
            <h1 className="text-3xl md:text-4xl font-bold text-white">Biblioteca de Manga</h1>
          </div>
          <button
            onClick={() => setShowModal(true)}
            className="bg-purple-600 hover:bg-purple-700 active:scale-95 text-white px-4 py-2.5 rounded-lg flex items-center gap-2 font-semibold transition-all duration-200 shadow-lg shadow-purple-600/30 hover:shadow-purple-600/50"
          >
      ...
      <main className="px-4 sm:px-6 md:px-12 py-8">
        <div className="max-w-[1800px] mx-auto flex flex-col md:flex-row items-center justify-between gap-3 bg-[#1e1e1e] rounded-lg px-4 py-3 shadow-md mb-8 flex-shrink-0">
          ...
          <button className="bg-purple-600 hover:bg-purple-700 text-white font-semibold px-3 py-2 rounded-md transition-all flex items-center gap-2 whitespace-nowrap text-sm">
