import { BookOpen, Plus, X, Image as ImageIcon, Trash2, GripVertical } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-b from-[#1f1f1f] to-[#121212] rounded-2xl border border-gray-700/40 w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl">
        <div className="sticky top-0 bg-gradient-to-b from-[#2a2a2a]/80 to-[#1f1f1f]/80 backdrop-blur-md border-b border-gray-700/30 px-8 py-6 flex items-center justify-between z-10">
          <div>
          ...
          <div className="bg-gradient-to-br from-[#242424] to-[#1a1a1a] rounded-xl p-6 border border-gray-700/40 shadow-lg hover:border-gray-700/60 transition-all">
            ...
            {previewUrl && !isProcessing && (
              <div className="mb-4 relative group max-w-xs mx-auto">
                {!previewLoaded && (
                  <div className="absolute inset-0 rounded-xl bg-[#1a1a1a] border border-gray-600 flex items-center justify-center z-10 aspect-[3/4]">
                    <LoadingSpinner size={50} borderWidth={3} />
                  </div>
                )}
                <img
                  src={previewUrl}
                  ...
                  className={`w-full aspect-[3/4] object-cover rounded-xl border border-gray-600 shadow-2xl shadow-[#bb86fc]/20 hover:shadow-[#bb86fc]/40 transition-all duration-700 ease-in-out hover:scale-[1.05] ${
                    previewLoaded ? 'animate-smooth-fade-in' : 'opacity-0 scale-95'
                  }`}
                />
                ...
                {selectedCoverPageIndex !== null && (
                  <div className="absolute bottom-2 left-2 bg-green-600/90 backdrop-blur-sm text-white text-xs px-2.5 py-1 rounded-lg font-semibold">
                  ...
                  {chapterPages.map((page, index) => (
                    ...
                    >
                      <img
                        src={page.thumbnail}
                        alt={`Página ${index + 1}`}
                        className="w-full aspect-[3/4] object-cover rounded-lg border border-gray-600/50 shadow-md group-hover:shadow-[#bb86fc]/30 transition-transform duration-700 ease-in-out group-hover:scale-[1.08]"
                      />
                      ...
                      <div className="absolute top-1.5 left-1.5 bg-black/80 backdrop-blur-sm text-white text-xs px-2 py-0.5 rounded-md font-semibold">
                        {index + 1}
                      </div>
                    </div>
                  ))}
      ...
      {showCoverSelector && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-gradient-to-b from-[#1f1f1f] to-[#121212] rounded-2xl border border-gray-700/40 w-full max-w-2xl max-h-[80vh] shadow-2xl overflow-hidden flex flex-col">
            <div className="bg-gradient-to-b from-[#2a2a2a]/80 to-[#1f1f1f]/80 backdrop-blur-md border-b border-gray-700/30 px-6 py-4 flex items-center justify-between flex-shrink-0">
              <div>
                ...
                {chapterPages.map((page, index) => (
                  ...
                  >
                    <img
                      src={page.thumbnail}
                      alt={`Página ${index + 1}`}
                      className="w-full h-full object-cover transition-transform duration-700 ease-in-out group-hover:scale-[1.10]"
                    />
                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <div className="bg-[#bb86fc]/90 backdrop-blur-sm text-white px-3 py-1.5 rounded-lg font-semibold text-sm">
                        Seleccionar
                      </div>
                    </div>
                    <div className="absolute bottom-2 left-2 bg-black/80 backdrop-blur-sm text-white text-xs px-2 py-1 rounded-md font-semibold">
                      {index + 1}
                    </div>
                    {selectedCoverPageIndex === index && (
                      <div className="absolute top-2 right-2 bg-green-600/90 backdrop-blur-sm text-white px-2.5 py-1.5 rounded-lg flex items-center gap-1.5 font-semibold text-xs">
            ...
            <div className="bg-gradient-to-b from-[#1f1f1f]/80 to-[#1a1a1a]/80 backdrop-blur-md border-t border-gray-700/30 px-6 py-4 flex items-center justify-end gap-3 flex-shrink-0">
              <button
                onClick={() => setShowCoverSelector(false)}
