...
export function ImageLightbox({ images, initialIndex, onClose }: ImageLightboxProps) {
  ...
  return (
    <div
      className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center z-50 opacity-0 transition-opacity duration-300 ease-out"
      style={{ opacity: 1 }}
        ...
        >
          <div className="relative">
            ...
            <img
              ...
              className="max-w-full max-h-[90vh] w-auto h-auto object-contain rounded-lg shadow-2xl opacity-0 blur-sm transition-opacity transition-filter duration-600 ease-in-out hover:scale-110 hover:transition-transform hover:duration-700"
              onLoad={(e) => {
